...
def execute_node_remove_do_release(
    ...
    *,
    ...
    preserve_static_node_precleanup_services: bool = False,
    ...
    try:
        ...
        try:
            ...
            static_node_precleanup = run_static_node_precleanup_gate(
                ...
                preserve_services=preserve_static_node_precleanup_services,
    ...
    evidence: dict[str, Any] = {
        ...
        "policy": {
            ...
            "static_node_precleanup_preserve_services": preserve_static_node_precleanup_services,
