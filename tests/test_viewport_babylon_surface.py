...
class ViewportSceneSurfaceTests(unittest.TestCase):
    def test_game_surface_tab_renders_shuttle3d_lookaround_surface(self) -> None:
        self.assertIn("Game Surface", APPLICATIONS_INDEX_HTML)
        self.assertIn("3D shuttle look-around is ready.", APPLICATIONS_INDEX_HTML)
        self.assertIn("forward viewport, stars, and the mother ship", APPLICATIONS_INDEX_HTML)
        ...
        self.assertIn("phase-2-shuttle-3d-lookaround", APPLICATIONS_INDEX_HTML)
        ...
        self.assertIn("Drag to look around", APPLICATIONS_INDEX_HTML)
