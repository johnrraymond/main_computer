...
class ViewportSceneSurfaceTests(unittest.TestCase):
    def test_game_surface_tab_renders_movable_shuttle3d_surface(self) -> None:
        ...
        self.assertIn("Vertex-built 3D shuttle walk-around is ready.", APPLICATIONS_INDEX_HTML)
        self.assertIn("Walk the bounded shuttle interior", APPLICATIONS_INDEX_HTML)
        ...
        self.assertIn("phase-4-shuttle-first-person-movement", APPLICATIONS_INDEX_HTML)
