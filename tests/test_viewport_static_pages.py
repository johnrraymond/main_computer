...
class ViewportStaticPageTests(unittest.TestCase):
    ...
    def test_graphical_index_contains_widget_hooks(self) -> None:
        ...
        self.assertIn("app, hub, worker, Ollama, Gitea, blockchain", GRAPHICAL_INDEX_HTML)
        self.assertIn("Main Computer App", GRAPHICAL_INDEX_HTML)
        self.assertIn("Hub Worker", GRAPHICAL_INDEX_HTML)
        self.assertIn("Git Server / Gitea", GRAPHICAL_INDEX_HTML)
        self.assertIn("Blockchain / Anvil", GRAPHICAL_INDEX_HTML)
        ...
        self.assertIn("telemetry-services", GRAPHICAL_INDEX_HTML)
        self.assertIn("service_summary", GRAPHICAL_INDEX_HTML)
        self.assertIn("known_port_time_wait_count", GRAPHICAL_INDEX_HTML)
        self.assertIn("active sockets", GRAPHICAL_INDEX_HTML)
