...
class ViewportStaticPageTests(unittest.TestCase):
    ...
    def test_application_routes_default_to_desktop(self) -> None:
        self.assertEqual(_application_route_target("/applications"), "desktop")
        self.assertEqual(_application_route_target("/apps"), "desktop")
        self.assertEqual(_application_route_target("/app"), "desktop")
        ...
        self.assertIn('href="/applications/calculator" data-app="calculator"', APPLICATIONS_INDEX_HTML)
        self.assertEqual(_application_route_target("/applications/desktop"), "desktop")
        self.assertEqual(_application_route_target("/apps/desktop"), "desktop")
        self.assertEqual(_application_route_target("/app/desktop"), "desktop")
        ...
        self.assertIn('if (!parts.length) return "desktop";', APPLICATIONS_INDEX_HTML)
        self.assertIn('let currentApp = "desktop";', APPLICATIONS_INDEX_HTML)
        ...
        self.assertIn('return normalized === "desktop" ? "/applications" : `/applications/${normalized}`;', APPLICATIONS_INDEX_HTML)
