...
class ViewportApplicationsStaticCoreTests(unittest.TestCase):
    def test_applications_index_contains_core_and_game_hooks(self) -> None:
        ...
        self.assertIn("Sell Local AI", APPLICATIONS_INDEX_HTML)
        self.assertIn("Buy Remote AI Policy", APPLICATIONS_INDEX_HTML)
        self.assertIn("Current seller offer", APPLICATIONS_INDEX_HTML)
        self.assertIn("Price per request", APPLICATIONS_INDEX_HTML)
        self.assertIn("Advanced availability ideas", APPLICATIONS_INDEX_HTML)
        self.assertIn("Preserved requester-side ideas", APPLICATIONS_INDEX_HTML)
        self.assertIn("Lock AI model when working", APPLICATIONS_INDEX_HTML)
        self.assertIn("Max credits per output token", APPLICATIONS_INDEX_HTML)
        self.assertIn("Charge per output token", APPLICATIONS_INDEX_HTML)
        self.assertIn('class="worker-drawer"', APPLICATIONS_INDEX_HTML)
        ...
        self.assertNotIn('id="desktop-overlay"', APPLICATIONS_INDEX_HTML)
