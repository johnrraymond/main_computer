...
@pytest.mark.parametrize(
    "script",
    [
        "tools/allfather_private_state.py",
        "tools/convert_allfather_to_mother.py",
        "tools/mother_initialize_from_allfather.py",
    ],
)
def test_allfather_state_and_conversion_entrypoints_fail_closed(script: str) -> None:
