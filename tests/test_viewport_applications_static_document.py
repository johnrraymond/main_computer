...
class ViewportApplicationsStaticDocumentTests(unittest.TestCase):
    def test_applications_index_contains_calculator_and_document_hooks(self) -> None:
            ...
            self.assertIn('data-mcel-workbench="document-editor"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout="page-centered-writing-workbench"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout-zone="menu"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout-zone="toolbar"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout-zone="navigation"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout-zone="primary"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout-zone="companion"', APPLICATIONS_INDEX_HTML)
            self.assertIn('data-mcel-layout-zone="status"', APPLICATIONS_INDEX_HTML)
            self.assertIn('"navigation primary companion"', APPLICATIONS_INDEX_HTML)
            self.assertIn('document-top-status', APPLICATIONS_INDEX_HTML)
            self.assertIn('document-menu-popover', APPLICATIONS_INDEX_HTML)
            ...
            self.assertIn('id="document-insert-game-scene"', APPLICATIONS_INDEX_HTML)
            self.assertIn('Game Scene Plugin', APPLICATIONS_INDEX_HTML)
            self.assertIn('game-scene-plugin', APPLICATIONS_INDEX_HTML)
            self.assertIn("promptAndInsertDocumentGameScenePlugin", APPLICATIONS_INDEX_HTML)
            self.assertIn("insertDocumentGameScenePlugin", APPLICATIONS_INDEX_HTML)
            self.assertIn("refreshDocumentGameScenePluginMounts", APPLICATIONS_INDEX_HTML)
            self.assertIn("/api/applications/game-editor/project/read", APPLICATIONS_INDEX_HTML)
            self.assertIn("plugin:mount", APPLICATIONS_INDEX_HTML)
