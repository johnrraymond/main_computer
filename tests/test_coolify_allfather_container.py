...
@pytest.mark.parametrize(
    "script",
    [
        "tools/coolify_allfather_container.py",
        "docker/allfather/entrypoint.py",
        "docker/allfather/healthcheck.py",
    ],
)
def test_allfather_container_entrypoints_fail_closed(script: str) -> None:
