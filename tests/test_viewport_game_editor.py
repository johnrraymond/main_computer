...
class ViewportGameEditorTests(unittest.TestCase):
    ...
    def test_projects_list_and_read_return_webgl_demo_default_with_hash(self) -> None:
        ...
        self.assertEqual(scene["metadata"]["rolloutPhase"], "phase-4-shuttle-first-person-movement")
        ...
        self.assertEqual(scene["metadata"]["controls"]["keyboard"], "wasd-and-arrow-keys")
        ...
        self.assertEqual(movement["start"], [0.0, 0.75, 3.35])
        self.assertEqual(movement["bounds"]["minZ"], -7.72)
        self.assertGreaterEqual(len(movement["colliders"]), 7)
        self.assertEqual(scene["metadata"]["camera"]["mode"], "first-person")
        self.assertEqual(scene["metadata"]["camera"]["position"], [0.0, 0.75, 3.35])
        ...
        self.assertEqual(scene["metadata"]["choreography"]["title"], "Shuttle Walk-Around Boot")
    ...
    def test_frontend_static_hooks_and_routes(self) -> None:
        ...
        self.assertIn("Vertex-built shuttle walk-around surface", APPLICATIONS_INDEX_HTML)
