...
class ViewportGameEditorTests(unittest.TestCase):
    ...
    def test_projects_list_and_read_return_webgl_demo_default_with_hash(self) -> None:
        ...
        self.assertEqual(interior["doors"]["door.bay-inner"]["state"], "locked")
        ...
        self.assertEqual(interior["doors"]["door.medbay"]["state"], "closed")
        self.assertEqual(interior["doors"]["door.science"]["state"], "closed")
