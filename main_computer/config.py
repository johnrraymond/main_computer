...
class MainComputerConfig:
    ...
    hub_enable_smoke_bridge: bool = False
    hub_require_multisession_auth: bool = False
    ...
    def from_env(cls) -> "MainComputerConfig":
        ...
        return cls(
            ...
            hub_enable_smoke_bridge=env_flag("MAIN_COMPUTER_HUB_ENABLE_SMOKE_BRIDGE", False),
            hub_require_multisession_auth=env_flag("MAIN_COMPUTER_HUB_REQUIRE_MULTISESSION_AUTH", False),
