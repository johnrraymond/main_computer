...
copies requirements, tests, acceptance contracts, observation contracts, or other
development-only package contents into the served web tree.
"""
...
_BROWSER_CONTRACT_KEYS = ("domain", "intents", "adapter", "surface", "layout")
