const astrometricApp = document.querySelector("#astrometric-app");
    ...
    const astrometricSmokeButton = document.querySelector("#astrometric-smoke-button");
    ...
    const astrometricDiagnoseButton = document.querySelector("#astrometric-diagnose-button");
