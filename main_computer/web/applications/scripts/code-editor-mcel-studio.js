    (() => {
      ...
      function normalizeMcelCommitBoundaryForReceipt(boundary = null, txDraftBoundary = {}) {
        ...
        return jsonSafeClone({
          ...
          wallet20bSignedIntentUnlock: source.wallet20bSignedIntentUnlock || source.walletSignedIntentUnlock || {},
          wallet20bSignedIntentStatus: source.wallet20bSignedIntentUnlock?.status || source.walletSignedIntentUnlock?.status || "not-observed",
          wallet20bSignedIntentStage: source.wallet20bSignedIntentUnlock?.stage || source.walletSignedIntentUnlock?.stage || "not-observed",
          wallet20bAllowedCapabilities: source.wallet20bSignedIntentUnlock?.allowedCapabilities || source.walletSignedIntentUnlock?.allowedCapabilities || [],
          wallet20bLockedCapabilities: source.wallet20bSignedIntentUnlock?.lockedCapabilities || source.walletSignedIntentUnlock?.lockedCapabilities || [],
          wallet20bProviderSignatureRequested: source.wallet20bSignedIntentUnlock?.providerSignatureRequested === true || source.walletSignedIntentUnlock?.providerSignatureRequested === true,
          wallet20cSignatureRequestPreflight: source.wallet20cSignatureRequestPreflight || source.walletSignatureRequestPreflight || {},
          wallet20cSignaturePreflightStatus: source.wallet20cSignatureRequestPreflight?.status || source.walletSignatureRequestPreflight?.status || "not-observed",
          wallet20cSignaturePreflightStage: source.wallet20cSignatureRequestPreflight?.stage || source.walletSignatureRequestPreflight?.stage || "not-observed",
          wallet20cAllowedCapabilities: source.wallet20cSignatureRequestPreflight?.allowedCapabilities || source.walletSignatureRequestPreflight?.allowedCapabilities || [],
          wallet20cLockedCapabilities: source.wallet20cSignatureRequestPreflight?.lockedCapabilities || source.walletSignatureRequestPreflight?.lockedCapabilities || [],
          ...
          wallet21dRetryRecoverySafety: source.wallet21dRetryRecoverySafety || source.walletRetryRecoverySafety || {},
          wallet21dRetryRecoveryStatus: source.wallet21dRetryRecoverySafety?.status || source.walletRetryRecoverySafety?.status || "not-observed",
          wallet21dDuplicateSendBlocked: source.wallet21dRetryRecoverySafety?.duplicateSendBlocked === true || source.walletRetryRecoverySafety?.duplicateSendBlocked === true,
          wallet21ePostConfirmationMcelReceiptIntegration: source.wallet21ePostConfirmationMcelReceiptIntegration || source.walletPostConfirmationReceiptIntegration || {},
          wallet21eReceiptIntegrationStatus: source.wallet21ePostConfirmationMcelReceiptIntegration?.status || source.walletPostConfirmationReceiptIntegration?.status || "not-observed",
          wallet21eChainOutcome: source.wallet21ePostConfirmationMcelReceiptIntegration?.chainOutcome || source.walletPostConfirmationReceiptIntegration?.chainOutcome || "not-observed",
          wallet21fRelockResetLifecycle: source.wallet21fRelockResetLifecycle || source.walletRelockResetLifecycle || {},
          wallet21fRelockLifecycleStatus: source.wallet21fRelockResetLifecycle?.status || source.walletRelockResetLifecycle?.status || "not-observed",
          wallet21fRequiresFreshDraftForNextSend: source.wallet21fRelockResetLifecycle?.requiresFreshDraftForNextSend === true || source.walletRelockResetLifecycle?.requiresFreshDraftForNextSend === true,
          wallet22aNetworkExecutionPolicyRegistry: source.wallet22aNetworkExecutionPolicyRegistry || source.walletNetworkExecutionPolicyRegistry || {},
          wallet22aNetworkExecutionPolicyDecision: source.wallet22aNetworkExecutionPolicyDecision || source.walletNetworkExecutionPolicyDecision || {},
          wallet22aNetworkExecutionPolicyStatus: source.wallet22aNetworkExecutionPolicyDecision?.status || source.walletNetworkExecutionPolicyDecision?.status || "not-observed",
          wallet22aNetworkPolicyMatched: source.wallet22aNetworkExecutionPolicyDecision?.policyMatched === true || source.walletNetworkExecutionPolicyDecision?.policyMatched === true,
          wallet22aAllowSendByPolicy: source.wallet22aNetworkExecutionPolicyDecision?.allowSendByPolicy === true || source.walletNetworkExecutionPolicyDecision?.allowSendByPolicy === true,
          wallet22bPolicyProfileImportSurface: source.wallet22bPolicyProfileImportSurface || source.walletPolicyProfileImportSurface || {},
          wallet22bPolicyProfileImportStatus: source.wallet22bPolicyProfileImportSurface?.status || source.walletPolicyProfileImportSurface?.status || "not-observed",
          wallet22bCanImportProfile: source.wallet22bPolicyProfileImportSurface?.canImportProfile === true || source.walletPolicyProfileImportSurface?.canImportProfile === true,
          wallet22cTargetRegistryContractBinding: source.wallet22cTargetRegistryContractBinding || source.walletTargetRegistryContractBinding || {},
          wallet22cTargetBindingStatus: source.wallet22cTargetRegistryContractBinding?.status || source.walletTargetRegistryContractBinding?.status || "not-observed",
          wallet22cTargetAllowed: source.wallet22cTargetRegistryContractBinding?.targetAllowed === true || source.walletTargetRegistryContractBinding?.targetAllowed === true,
          wallet22dProductionPolicyHardening: source.wallet22dProductionPolicyHardening || source.walletProductionPolicyHardening || {},
          wallet22dProductionPolicyStatus: source.wallet22dProductionPolicyHardening?.status || source.walletProductionPolicyHardening?.status || "not-observed",
          wallet22dProductionReady: source.wallet22dProductionPolicyHardening?.productionReady === true || source.walletProductionPolicyHardening?.productionReady === true,
          wallet22ePolicyActivationRevocationLifecycle: source.wallet22ePolicyActivationRevocationLifecycle || source.walletPolicyActivationRevocationLifecycle || {},
          wallet22ePolicyActivationStatus: source.wallet22ePolicyActivationRevocationLifecycle?.status || source.walletPolicyActivationRevocationLifecycle?.status || "not-observed",
          wallet22ePolicyActive: source.wallet22ePolicyActivationRevocationLifecycle?.policyActive === true || source.walletPolicyActivationRevocationLifecycle?.policyActive === true,
          wallet22fPolicyBoundExecutionReadinessSurface: source.wallet22fPolicyBoundExecutionReadinessSurface || source.walletPolicyBoundExecutionReadinessSurface || {},
          wallet22fExecutionReadinessStatus: source.wallet22fPolicyBoundExecutionReadinessSurface?.status || source.walletPolicyBoundExecutionReadinessSurface?.status || "not-observed",
          wallet22fReadyFor23a: source.wallet22fPolicyBoundExecutionReadinessSurface?.readyFor23aMultiNetworkExecutionPolish === true || source.walletPolicyBoundExecutionReadinessSurface?.readyFor23aMultiNetworkExecutionPolish === true,
          wallet23aLiveNetworkExecutionPolish: source.wallet23aLiveNetworkExecutionPolish || source.walletLiveNetworkExecutionPolish || {},
          wallet23aLiveRouteStatus: source.wallet23aLiveNetworkExecutionPolish?.status || source.walletLiveNetworkExecutionPolish?.status || "not-observed",
          wallet23aCanExecuteRoute: source.wallet23aLiveNetworkExecutionPolish?.canExecuteRoute === true || source.walletLiveNetworkExecutionPolish?.canExecuteRoute === true,
          wallet23bTransactionObserver: source.wallet23bTransactionObserver || source.walletTransactionFinalityObserver || {},
          wallet23bTransactionObserverStatus: source.wallet23bTransactionObserver?.status || source.walletTransactionFinalityObserver?.status || "not-observed",
          wallet23bFinalitySatisfied: source.wallet23bTransactionObserver?.finalitySatisfied === true || source.walletTransactionFinalityObserver?.finalitySatisfied === true,
          wallet23bTxHashAloneIsSuccess: source.wallet23bTransactionObserver?.txHashAloneIsSuccess === true || source.walletTransactionFinalityObserver?.txHashAloneIsSuccess === true,
          wallet23cSafeRecoveryPlanner: source.wallet23cSafeRecoveryPlanner || source.walletSafeRecoveryPlanner || {},
          wallet23cRecoveryPlannerStatus: source.wallet23cSafeRecoveryPlanner?.status || source.walletSafeRecoveryPlanner?.status || "not-observed",
          wallet23cSameEnvelopeRetryBlocked: source.wallet23cSafeRecoveryPlanner?.sameEnvelopeRetryBlocked === true || source.walletSafeRecoveryPlanner?.sameEnvelopeRetryBlocked === true,
          wallet23cCanRetryAutomatically: source.wallet23cSafeRecoveryPlanner?.canRetryAutomatically === true || source.walletSafeRecoveryPlanner?.canRetryAutomatically === true,
          wallet23dExecutionAuditExport: source.wallet23dExecutionAuditExport || source.walletExecutionAuditExport || {},
          wallet23dExecutionAuditExportStatus: source.wallet23dExecutionAuditExport?.status || source.walletExecutionAuditExport?.status || "not-observed",
          wallet23dAuditPacketHash: source.wallet23dExecutionAuditExport?.auditPacketHash || source.walletExecutionAuditExport?.auditPacketHash || "",
          wallet23dRedactionMode: source.wallet23dExecutionAuditExport?.executionAuditRedactionPolicy?.mode || source.walletExecutionAuditExport?.executionAuditRedactionPolicy?.mode || "redacted",
          ...
          retryRecoverySafetyActive: Boolean(source.wallet21dRetryRecoverySafety?.status || source.walletRetryRecoverySafety?.status),
          postConfirmationReceiptIntegrated: Boolean(source.wallet21ePostConfirmationMcelReceiptIntegration?.status || source.walletPostConfirmationReceiptIntegration?.status),
          relockResetLifecycleActive: Boolean(source.wallet21fRelockResetLifecycle?.status || source.walletRelockResetLifecycle?.status),
          networkPolicyDecisionActive: Boolean(source.wallet22aNetworkExecutionPolicyDecision?.status || source.walletNetworkExecutionPolicyDecision?.status),
          policyProfileImportSurfaceActive: Boolean(source.wallet22bPolicyProfileImportSurface?.status || source.walletPolicyProfileImportSurface?.status),
          targetRegistryBindingActive: Boolean(source.wallet22cTargetRegistryContractBinding?.status || source.walletTargetRegistryContractBinding?.status),
          liveNetworkExecutionPolishActive: Boolean(source.wallet23aLiveNetworkExecutionPolish?.status || source.walletLiveNetworkExecutionPolish?.status),
          transactionFinalityObserverActive: Boolean(source.wallet23bTransactionObserver?.status || source.walletTransactionFinalityObserver?.status),
          safeRecoveryPlannerActive: Boolean(source.wallet23cSafeRecoveryPlanner?.status || source.walletSafeRecoveryPlanner?.status),
          executionAuditExportActive: Boolean(source.wallet23dExecutionAuditExport?.status || source.walletExecutionAuditExport?.status),
          blockers,
          ...
          nextAction: source.wallet23dExecutionAuditExport?.nextAction || source.walletExecutionAuditExport?.nextAction || source.wallet23cSafeRecoveryPlanner?.nextAction || source.walletSafeRecoveryPlanner?.nextAction || source.wallet23aLiveNetworkExecutionPolish?.nextAction || source.walletLiveNetworkExecutionPolish?.nextAction || source.wallet23bTransactionObserver?.nextAction || source.walletTransactionFinalityObserver?.nextAction || source.wallet22fPolicyBoundExecutionReadinessSurface?.nextAction || source.walletPolicyBoundExecutionReadinessSurface?.nextAction || source.wallet22ePolicyActivationRevocationLifecycle?.nextAction || source.walletPolicyActivationRevocationLifecycle?.nextAction || source.wallet22dProductionPolicyHardening?.nextAction || source.walletProductionPolicyHardening?.nextAction || source.wallet22cTargetRegistryContractBinding?.nextAction || source.walletTargetRegistryContractBinding?.nextAction || source.wallet22bPolicyProfileImportSurface?.nextAction || source.walletPolicyProfileImportSurface?.nextAction || source.wallet22aNetworkExecutionPolicyDecision?.nextAction || source.walletNetworkExecutionPolicyDecision?.nextAction || source.wallet21fRelockResetLifecycle?.nextAction || source.walletRelockResetLifecycle?.nextAction || source.wallet21ePostConfirmationMcelReceiptIntegration?.nextAction || source.walletPostConfirmationReceiptIntegration?.nextAction || source.wallet21dRetryRecoverySafety?.nextAction || source.walletRetryRecoverySafety?.nextAction || source.wallet21cTransactionWatcher?.nextAction || source.walletTransactionWatcher?.nextAction || source.wallet21bProviderOutcomeLedger?.nextAction || source.walletProviderOutcomeLedger?.nextAction || source.wallet21aPolicyBoundSendGate?.nextAction || source.walletTransactionSendGate?.nextAction || source.wallet20gProviderIntentHardening?.nextAction || source.walletProviderIntentHardening?.nextAction || source.wallet20fPreSendReviewGate?.nextAction || source.walletPreSendReviewGate?.nextAction || source.wallet20eSignedIntentVerification?.nextAction || source.walletSignedIntentVerification?.nextAction || source.wallet20dProviderIntentSignature?.nextAction || source.walletProviderIntentSignature?.nextAction || source.wallet20cSignatureRequestPreflight?.nextAction || source.walletSignatureRequestPreflight?.nextAction || source.wallet20bSignedIntentUnlock?.nextAction || source.walletSignedIntentUnlock?.nextAction || source.wallet20aUnlockContract?.nextAction || source.walletUnlockContract?.nextAction || source.wallet18nCompletionReport?.nextAction || source.nextAction || preflight.summary || consumerGate.reason || "",
      ...
      function summarizeMcelCommitBoundaryForWorkbench(receiptVector = studioState.lastScmReceiptVector) {
        ...
        const label = observed
          ? `${status} · ${boundary.action || "wallet.send-sign"} · validity=${boundary.txDraftValidityStatus || "not-observed"} · 19D=${boundary.wallet19dProofSurfaceAlignmentStatus || "not-observed"} · 19E=${boundary.wallet19eNegativePathRegressionStatus || "not-observed"} · 20A=${boundary.wallet20aUnlockContractStage || "not-observed"} · 20B=${boundary.wallet20bSignedIntentStage || "not-observed"} · 20C=${boundary.wallet20cSignaturePreflightStage || "not-observed"} · 20D=${boundary.wallet20dProviderIntentStage || "not-observed"} · 20E=${boundary.wallet20eSignedIntentVerificationStage || "not-observed"} · 20F=${boundary.wallet20fPreSendReviewStage || "not-observed"} · 20G=${boundary.wallet20gProviderIntentHardeningStage || "not-observed"} · 21D=${boundary.wallet21dRetryRecoveryStatus || "not-observed"} · 21E=${boundary.wallet21eReceiptIntegrationStatus || "not-observed"} · 21F=${boundary.wallet21fRelockLifecycleStatus || "not-observed"} · 22A=${boundary.wallet22aNetworkExecutionPolicyStatus || "not-observed"} · 22B=${boundary.wallet22bPolicyProfileImportStatus || "not-observed"} · 22C=${boundary.wallet22cTargetBindingStatus || "not-observed"} · 22D=${boundary.wallet22dProductionPolicyStatus || "not-observed"} · 22E=${boundary.wallet22ePolicyActivationStatus || "not-observed"} · 22F=${boundary.wallet22fExecutionReadinessStatus || "not-observed"} · 23A=${boundary.wallet23aLiveRouteStatus || "not-observed"} · 23B=${boundary.wallet23bTransactionObserverStatus || "not-observed"} · canSend=${boundary.canSend === true} canSign=${boundary.canSign === true} canBroadcast=${boundary.canBroadcast === true}`
          : "not observed";
        return jsonSafeClone({
          ...
          wallet20bSignedIntentUnlock: boundary.wallet20bSignedIntentUnlock || {},
          wallet20bSignedIntentStatus: boundary.wallet20bSignedIntentStatus || "not-observed",
          wallet20bSignedIntentStage: boundary.wallet20bSignedIntentStage || "not-observed",
          wallet20bAllowedCapabilities: boundary.wallet20bAllowedCapabilities || [],
          wallet20bLockedCapabilities: boundary.wallet20bLockedCapabilities || [],
          wallet20bProviderSignatureRequested: boundary.wallet20bProviderSignatureRequested === true,
          wallet20cSignatureRequestPreflight: boundary.wallet20cSignatureRequestPreflight || {},
          wallet20cSignaturePreflightStatus: boundary.wallet20cSignaturePreflightStatus || "not-observed",
          wallet20cSignaturePreflightStage: boundary.wallet20cSignaturePreflightStage || "not-observed",
          wallet20cAllowedCapabilities: boundary.wallet20cAllowedCapabilities || [],
          wallet20cLockedCapabilities: boundary.wallet20cLockedCapabilities || [],
          ...
          wallet21dRetryRecoverySafety: boundary.wallet21dRetryRecoverySafety || {},
          wallet21dRetryRecoveryStatus: boundary.wallet21dRetryRecoveryStatus || "not-observed",
          wallet21dDuplicateSendBlocked: boundary.wallet21dDuplicateSendBlocked === true,
          wallet21ePostConfirmationMcelReceiptIntegration: boundary.wallet21ePostConfirmationMcelReceiptIntegration || {},
          wallet21eReceiptIntegrationStatus: boundary.wallet21eReceiptIntegrationStatus || "not-observed",
          wallet21eChainOutcome: boundary.wallet21eChainOutcome || "not-observed",
          wallet21fRelockResetLifecycle: boundary.wallet21fRelockResetLifecycle || {},
          wallet21fRelockLifecycleStatus: boundary.wallet21fRelockLifecycleStatus || "not-observed",
          wallet21fRequiresFreshDraftForNextSend: boundary.wallet21fRequiresFreshDraftForNextSend === true,
          wallet22aNetworkExecutionPolicyRegistry: boundary.wallet22aNetworkExecutionPolicyRegistry || {},
          wallet22aNetworkExecutionPolicyDecision: boundary.wallet22aNetworkExecutionPolicyDecision || {},
          wallet22aNetworkExecutionPolicyStatus: boundary.wallet22aNetworkExecutionPolicyStatus || "not-observed",
          wallet22aNetworkPolicyMatched: boundary.wallet22aNetworkPolicyMatched === true,
          wallet22aAllowSendByPolicy: boundary.wallet22aAllowSendByPolicy === true,
          wallet22bPolicyProfileImportSurface: boundary.wallet22bPolicyProfileImportSurface || {},
          wallet22bPolicyProfileImportStatus: boundary.wallet22bPolicyProfileImportStatus || "not-observed",
          wallet22bCanImportProfile: boundary.wallet22bCanImportProfile === true,
          wallet22cTargetRegistryContractBinding: boundary.wallet22cTargetRegistryContractBinding || {},
          wallet22cTargetBindingStatus: boundary.wallet22cTargetBindingStatus || "not-observed",
          wallet22cTargetAllowed: boundary.wallet22cTargetAllowed === true,
          wallet22dProductionPolicyHardening: boundary.wallet22dProductionPolicyHardening || {},
          wallet22dProductionPolicyStatus: boundary.wallet22dProductionPolicyStatus || "not-observed",
          wallet22dProductionReady: boundary.wallet22dProductionReady === true,
          wallet22ePolicyActivationRevocationLifecycle: boundary.wallet22ePolicyActivationRevocationLifecycle || {},
          wallet22ePolicyActivationStatus: boundary.wallet22ePolicyActivationStatus || "not-observed",
          wallet22ePolicyActive: boundary.wallet22ePolicyActive === true,
          wallet22fPolicyBoundExecutionReadinessSurface: boundary.wallet22fPolicyBoundExecutionReadinessSurface || {},
          wallet22fExecutionReadinessStatus: boundary.wallet22fExecutionReadinessStatus || "not-observed",
          wallet22fReadyFor23a: boundary.wallet22fReadyFor23a === true,
          wallet23aLiveNetworkExecutionPolish: boundary.wallet23aLiveNetworkExecutionPolish || {},
          wallet23aLiveRouteStatus: boundary.wallet23aLiveRouteStatus || "not-observed",
          wallet23aCanExecuteRoute: boundary.wallet23aCanExecuteRoute === true,
          wallet23bTransactionObserver: boundary.wallet23bTransactionObserver || {},
          wallet23bTransactionObserverStatus: boundary.wallet23bTransactionObserverStatus || "not-observed",
          wallet23bFinalitySatisfied: boundary.wallet23bFinalitySatisfied === true,
          wallet23bTxHashAloneIsSuccess: boundary.wallet23bTxHashAloneIsSuccess === true,
          ...
          nextAction: boundary.nextAction || (observed ? "inspect MCEL 21D/21E/21F retry safety, receipt integration, and relock lifecycle after policy-bound send" : "run MCEL Lab wallet proof"),
          raw: boundary
        });
      }
      ...
      function mcelProofDockCommitBoundarySpecimen({
        ...
        return jsonSafeClone({
          ...
          invariant: [
            ...
            "20D/20E/20F proof dock markers remain visible.",
            "20D/20E/20F/20G provider review markers remain visible.",
