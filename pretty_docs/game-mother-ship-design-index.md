...
| `pretty_docs/game-ai-patch-10-a-character-policy-and-playable-characters.md` | Implemented constrained AI-10A stable character policy interface, one playable raider boarder, Engineering Officer Mara Venn, one raider vessel identity, receipts, local persistence, and deterministic fallback |
| `pretty_docs/game-ai-patch-10-b-pax-neutrality-under-fire.md` | Implemented AI-10B reusable system-scenario runtime and the complete Pax protection, investigation, conduct-aware conference, consequence, character, and support-cutter slice |
...
AI-1 through AI-9.4.1 are implemented, and this snapshot includes the constrained AI-10A character foundation plus AI-10B's complete Pax scenario: the strategic coordinator preserves its existing cognition and authority boundaries; Vela, Solace, travel, and the non-obscuring strategic dock remain intact; the WebGL game has stable Solace and Pax characters behind bounded perceptions and legal actions; and Pax now runs a navigation-gated protection, evidence, conduct, conference, and consequence state machine with a Quiet Service support cutter. Repository-backed strategic, character, and system-scenario saves, a real model call, broader scene performance, and learned policies remain unimplemented.
